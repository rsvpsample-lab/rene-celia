...
import cover2Image from '@assets/cover2_1762011709672.JPG';
...
const Index = () => {
  ...
  return (
    <AnimationContext.Provider value={{ animationsEnabled }}>
      ...
      >
        <source
          src="https://res.cloudinary.com/dkazjosk5/video/upload/v1762066297/ytmp3free.cc_perfect-ed-sheeran-saxophone-version-youtubemp3free.org_rlmiu1.mp3"
          type="audio/mpeg"
        />
      ...
      <div className="min-h-screen relative">
        ...
        <main className="relative z-10">
          ...
          <CoverSection
            ...
            alt="Rene & Celia Wedding Cover Image 1"
          />
          <ScrollTriggeredTimeline />
          <VenueSection />
          <CoverSection
            imageUrl={cover2Image}
            alt="Rene & Celia Wedding Cover Image 2"
          />
          <DressCodeSection />
          <HashtagGiftsSection />
          <RSVPSection />
          ...
          <CoverSection
            ...
            alt="Rene & Celia Wedding Cover Image 3"
          />
          <FAQSection />
          <Footer />
        </main>
